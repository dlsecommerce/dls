...
/**
 * ✅ Helpers de URL/state persistente
 */
...
export default function PricingTable() {
   ...
   * Exemplo:
   * ?search=tramontina&page=2&perPage=50&lojas=PK,SB&brands=Tramontina&sortColumn=Marca&sortDirection=asc
   */
  ...
  /**
   * ✅ Se usuário usar refresh, link compartilhado, voltar/avançar do navegador,
   * o estado é reidratado da URL.
   */
  useEffect(() => {
  ...
  /**
   * ✅ Estado -> URL
   * Mantém busca, filtros, paginação e ordenação mesmo com refresh.
   */
  useEffect(() => {
  ...
  try {
    // 🔊 desbloqueia áudio no clique do botão

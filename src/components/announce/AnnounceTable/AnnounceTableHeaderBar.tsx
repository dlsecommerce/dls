...
const TABLE_GRID =
  "grid-cols-[48px_120px_120px_140px_140px_140px_minmax(260px,1fr)_160px_120px]";
...
export default function AnnounceTableHeaderBar({
  ...
  return (
    <div className="w-full overflow-x-auto lg:overflow-visible">
      <div className="min-w-[1328px] border-b border-neutral-700 bg-transparent">
        ...
        <div className={`grid ${TABLE_GRID} items-center gap-0 px-4 pb-3`}>
          ...
          <HeaderCell align="center">
            <div className="text-sm font-semibold text-neutral-500">Ações</div>
          </HeaderCell>
        </div>
      </div>
    </div>

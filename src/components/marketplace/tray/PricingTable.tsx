...
import { useTrayImportExport } from "@/components/marketplace/tray/hooks/useTrayImportExport";
import { Table, TableBody } from "@/components/ui/table";
import { GlassmorphicCard } from "@/components/ui/glassmorphic-card";
import { TableControls } from "@/components/announce/AnnounceTable/TableControls";

import { FloatingEditor } from "@/components/marketplace/tray/FloatingEditor";
import { TableRows } from "@/components/marketplace/tray/TableRows";
import TrayFilters from "@/components/marketplace/tray/TrayFilters";
import TrayActionsSidebar from "@/components/marketplace/tray/TrayActionsSidebar";
import PricingHeaderTray from "@/components/marketplace/tray/PricingHeaderTray";
import PricingMassEditionModal from "@/components/marketplace/tray/PricingMassEditionModal";

import { toBR, parseBR } from "@/components/marketplace/tray/hooks/helpers";
import { Row } from "@/components/marketplace/tray/hooks/types";

import {
  TrayFilters as TrayFiltersType,
  DEFAULT_TRAY_FILTERS,
} from "@/components/marketplace/tray/types";
...
export default function PricingTable() {
  ...
  // 🔹 Busca todas as marcas distintas para popular o combobox de marca (com paginação)
  useEffect(() => {
    let cancelled = false;
  ...
  useEffect(() => {
    ...
    const nextBrands = filters.marca
      .split(",")
      .map((m) => m.trim())
      .filter(Boolean);

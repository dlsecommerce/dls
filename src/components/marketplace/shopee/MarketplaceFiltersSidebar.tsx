...
/*
  ...
  Sem chips verdes — a seleção fica visível apenas no checkbox marcado.
*/
...
export default function MarketplaceFiltersSidebar({
  ...
  const updateLocalFilter = (key: keyof MarketplaceFilters, value: string) => {
  ...
  const clearFilters = () => {
    setLocalSearch("");
    setLocalFilters(DEFAULT_MARKETPLACE_FILTERS);
    setSearch("");
